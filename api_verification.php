...
switch ($flag) {
    ...
    case 2:
    		...
    		if(mysqli_num_rows($result)>0){
    			...
    			//$query = "INSERT INTO users (userid, Name, Email, Mobile, Password, fcm_token, status) VALUES ('$idnomax','$Name','$Email','$Mobile','$Password','$fcm_token', 1)";
    			$query = "INSERT INTO users (userid,  Password, USERNAME,HINT,ANSWER) VALUES ('$idnomax','$Password','$Email','SAMPLE','ANSWER')";
